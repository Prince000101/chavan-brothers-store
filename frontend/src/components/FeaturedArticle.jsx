  ...
  return (
    <div className="relative rounded-[16px] sm:rounded-[28px] overflow-hidden mb-10 sm:mb-14">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-forest/90 via-forest/70 to-forest/30 sm:via-forest/60 sm:to-transparent flex flex-col justify-center p-5 sm:p-8 md:p-16">
        ...
        <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-playfair font-bold text-cream max-w-xl md:max-w-2xl leading-tight">Ancient Spice Wisdom for Modern Kitchens</h2>
        <p className="text-cream/70 font-dm mt-2 sm:mt-5 max-w-lg text-xs sm:text-base">Explore the timeless art of spice blending and Mumbai's rich culinary heritage.</p>

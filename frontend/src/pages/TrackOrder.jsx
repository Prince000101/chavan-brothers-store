  ...
  return (
    <div className="min-h-screen px-4 sm:px-6 py-12 sm:py-16 md:px-14 lg:px-24 transition-colors duration-500">
      <SEO
        ...
        description="Track the status of your Chavan Brothers masala order. Enter your order ID to see real-time delivery updates."
        keywords="Chavan Brothers track order, order status, delivery tracking"
        url="https://chavanbrothers.com/track-order"
      />

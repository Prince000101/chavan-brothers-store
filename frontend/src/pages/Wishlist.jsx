...
function Wishlist() {
  ...
  return (
    <div className="min-h-screen px-6 py-20 md:px-14 lg:px-24 transition-colors duration-500">
      <SEO
        title="Wishlist"
        description="Your saved Chavan Brothers masalas and spice blends. Keep track of your favorite authentic Mumbai spices."
        keywords="Chavan Brothers wishlist, saved spices, favorite masalas"
        url="https://chavanbrothers.com/wishlist"
      />

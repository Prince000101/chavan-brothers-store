...
function Checkout() {
  ...
  return (
    <div className="min-h-screen px-4 sm:px-6 py-12 sm:py-16 md:px-14 lg:px-24 transition-colors duration-500">
      <SEO
        title="Checkout"
        description="Complete your order of authentic Mumbai masalas from Chavan Brothers. Secure checkout with free shipping across India."
        keywords="Chavan Brothers checkout, order masalas, buy spices online"

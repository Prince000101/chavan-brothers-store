...
const Register = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 sm:px-6 transition-colors duration-500">
      <SEO
        title="Register"
        description="Create your Chavan Brothers account to start ordering authentic Mumbai masalas, save your wishlist, and track your orders."
        keywords="Chavan Brothers register, create account, sign up spices"
        url="https://chavanbrothers.com/register"
      />

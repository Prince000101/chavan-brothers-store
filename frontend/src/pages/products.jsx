          ...
          {filteredProducts.map((product, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-spice/40 opacity-0 transition-all duration-300 group-hover:opacity-100 max-sm:hidden">
                  <button onClick={(e) => { e.stopPropagation(); setSelectedProduct(product); }} className="flex items-center gap-2 rounded-lg bg-white/95 px-4 sm:px-5 py-2 sm:py-3 font-body font-bold uppercase tracking-wider text-spice shadow-xl transition hover:scale-105">
